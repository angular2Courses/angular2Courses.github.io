...
/***/ function(module, exports, __webpack_require__) {
	...
	quakes.subscribe(function (_a) {
	    ...
	    point.addTo(map);
	    places.push({ point: point, place: place });
	});
	var mouseEv = Observable_1.Observable.fromEvent(document, 'mousemove');
	var hover = mouseEv
	    .filter(function (e) { return e.target.tagName === 'path'; })
	    .mergeMap(function (ev) { return Observable_1.Observable.from(places)
	    .filter(function (quake) { return quake.point._path === ev.target; })
	    .map(function (quake) {
	    return { place: quake.place, x: ev.pageX, y: ev.pageY };
	}); });
	var unhover = mouseEv
	    .filter(function (e) { return e.target.tagName !== 'path'; });
	hover.subscribe(function (ev) {
	    popup.style.top = ev.y + 20 + "px";
	    popup.style.left = ev.x + 20 + "px";
	    popup.style.display = "block";
	    popup.innerHTML = ev.place;
	});
	unhover.subscribe(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(1);
	var from_1 = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var FromObservable_1 = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArray_1 = __webpack_require__(7);
	var isPromise_1 = __webpack_require__(18);
	var PromiseObservable_1 = __webpack_require__(19);
	var IteratorObservable_1 = __webpack_require__(20);
	var ArrayObservable_1 = __webpack_require__(22);
	var ArrayLikeObservable_1 = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(1);
	var fromEvent_1 = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var FromEventObservable_1 = __webpack_require__(31);
